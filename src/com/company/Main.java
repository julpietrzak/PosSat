...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       /*{d17}*/Double.parseDouble(String.valueOf(new wyciag_date(d5)));
        ...
        if(d21*d11>=0){d36=d12+Math.floor(d21*d11);}
        else {d36=d12+Math.ceil(d21*d11);}
        ...
        d48=(360-(d32+d47)+d20);
        /*{d49}*/ if (Math.cos(d43*PI/180)<0)  {d49=Double.parseDouble(String.valueOf(new Rang(d48-180)));} else {d49=Double.parseDouble(String.valueOf(new Rang(d48)));}
        /*{d50}*/ if(d49<180)  {d50=-d49;} else {d50=360-d49;}
